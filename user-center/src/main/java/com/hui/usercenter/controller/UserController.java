package com.hui.usercenter.controller;
...
import com.hui.usercenter.model.domain.request.UserLoginRequest;
import com.hui.usercenter.model.domain.request.UserRegisterRequest;
...
import static com.hui.usercenter.contant.UserConstant.ADMIN_ROLE;
...
@RestController
@RequestMapping("/user")
// @CrossOrigin(origins = {"http://62.234.174.153"},methods = {RequestMethod.GET,RequestMethod.POST})
